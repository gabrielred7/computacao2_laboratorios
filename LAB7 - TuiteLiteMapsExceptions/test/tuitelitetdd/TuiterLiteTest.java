...
import tuitelitemapsexcpetions.NivelUsuario;
import tuitelitemapsexcpetions.TamanhoMaximoExcedidoException;
import tuitelitemapsexcpetions.Tuite;
import tuitelitemapsexcpetions.TuiterLite;
import tuitelitemapsexcpetions.Usuario;
...
public class TuiterLiteTest {
    ...
    public void testeTuiteDeUsuarioDesconhecido() throws TamanhoMaximoExcedidoException {
        assertNull("Não deve ser possível tuitar algo se o usuário é desconhecido",
                tuiterLite.tuitarAlgo(new Usuario("Usuário Desconhedido", "unknown@void.com"),
                        "Testando"));
    }
    ...
    public void testePerformanceTuites() throws TamanhoMaximoExcedidoException {
        ...
        System.out.println("duracao = " + (System.currentTimeMillis() - inicio) + " milissegundos");
    }
}